...
class TrackHelper {
 ...
 public:
  ...
  static bool FindTrackInCollection(const reco::Track& trackToFind, const reco::TrackCollection& trackCollection);
...
inline bool TrackHelper::FindTrackInCollection(const reco::Track& trackToFind, const reco::TrackCollection& trackCollection) {
  return std::any_of(trackCollection.begin(), trackCollection.end(),
		     [&trackToFind](const reco::Track& track) {
		       return SameTrack(trackToFind, track);
		     });
}
